...
@Component({
  selector: 'app-dialogallnovedades',
  templateUrl: './dialogallnovedades.component.html',
  styleUrls: ['./dialogallnovedades.component.css']
})
export class DialogallnovedadesComponent implements OnInit {
